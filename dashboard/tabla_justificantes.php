                    ...
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="justificantes.php?id=<?php echo $dat['id']; ?>" class="btn btn-success mb-2"   title="Generar justificante de <?php echo $dat['nombre']; ?>">
